...
include("config.jl")
#set up the fit
include(joinpath(@__DIR__, "../../utiles/setupFit.jl"))
...
save(joinpath(@__DIR__, "./bestfits/trial_b1_p.jld2"), "solstats", solstats, "bfparameters", bfparameters, "cloneid", cloneid, "minobj", minval, "minidx", minidx, "estimate_signal", estimate_signal)
