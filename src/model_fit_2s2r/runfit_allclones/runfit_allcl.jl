...
pathToLog = "/tungstenfs/scratch/ggiorget/Gregory/julia/FitStoThyLiveCell/src/models/m_2s2r/run_allcl_20250218_11_p1/log_cl$(cloneid[CLIDX])/"
...
save("./models/m_2s2r/run_allcl_20250218_11_p1/bestfits/fcfca7c6_p"*"_cl$(cloneid[CLIDX])"*".jld2", "solstats", solstats, "bfparameters", bfparameters, "cloneid", cloneid[CLIDX], "minobj", minval, "minidx", minidx, "estimate_signal", estimate_signal)
