...
pathToLog = "/tungstenfs/scratch/ggiorget/Gregory/julia/FitStoThyLiveCell/src/models/m_2s2r/run_allcl_20250218_11_p1/log_cl$(cloneid[3])/"
#set up the data to fit
data_all = dataToFit(dataname, cloneid[3], tmax_nextburst, tmax_intensity)
...
save("./models/m_2s2r/run_allcl_20250218_11_p1/bestfits/fcfca7c6_p"*"_cl$(cloneid[3])"*".jld2", "solstats", solstats, "bfparameters", bfparameters, "cloneid", cloneid[3], "minobj", minval, "minidx", minidx, "estimate_signal", estimate_signal)
